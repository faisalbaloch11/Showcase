...
const App=()=> {
  return (
    <>
      ...
      "
      description="
      Experience a buttery UI of ProNef NFT Marketplace. Smooth constant colors of a fluent UI design.
      "
    ...
    <Features/>
      <SectionWrapper
      title=" Deployment"
      description="ProNef is built using Expo which runs natively on all user'
      ...
      <SectionWrapper
      title="
      Creative way to showcase the store
      "
      description="
